...
const THEME_EVENT = "tm-theme-change";
...
export function ThemeToggle() {
  // useSyncExternalStore to zalecany sposób czytania stanu spoza Reacta
  // (tu: klasa .dark na <html>) bez ryzyka „mignięcia" i bez setState w efekcie.
  ...
  function toggle() {
    ...
    try {
      ...
      // brak dostępu do localStorage — ignorujemy, motyw zadziała w obrębie sesji
    }
